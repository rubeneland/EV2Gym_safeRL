...
def train_cvpo(args):
        ...
        run_name= f'cvpo_v35_hard_constraint_0_4_SOC_h20_100_usr_5spawn_10cs_cost_lim_{cost_limit}_train_envs_{training_num}_test_envs_{testing_num}_run{random.randint(0, 1000)}'
