    ...
    for algorithm in algorithms:
        ...
        for k in range(n_test_cycles):
            ...
            if algorithm in [PPO, A2C, DDPG, SAC, TD3, TQC, TRPO, ARS, RecurrentPPO]:
                ...
                load_path = 'fsrl_logs/TEST_FINAL_10_cs_120kw/32_test_envs_no_loads_no_PV_no_DR_CVPO_5spawn_10cs_120kw_cost_lim_90_usr_-4_100_NO_tr_train_envs_4_test_envs_32_run442/checkpoint/model.pt'
