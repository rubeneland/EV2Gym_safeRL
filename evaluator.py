    ...
    for algorithm in algorithms:
        ...
        for k in range(n_test_cycles):
            ...
            if algorithm in [PPO, A2C, DDPG, SAC, TD3, TQC, TRPO, ARS, RecurrentPPO]:
                ...
                load_path = 'fsrl_logs/exp_1_no_loads_no_pv_10_cs_spawn_5/cvpo_TEST_add_reward_h20_100_v2g_cost_40_5spawn_10cs_90kw_cost_lim_40_train_envs_1_test_envs_4_run851/checkpoint/model_best.pt'
